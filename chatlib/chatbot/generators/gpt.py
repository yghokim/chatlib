...
from chatlib.chatbot import TokenLimitExceedHandler, ChatCompletionResponseGenerator
from chatlib.openai_utils import GPTChatCompletionAPI


class ChatGPTResponseGenerator(ChatCompletionResponseGenerator):
    def __init__(self,  model: str, base_instruction: str | Template | None = None,
        ...
        super().__init__(GPTChatCompletionAPI(), model, base_instruction, instruction_parameters, initial_user_message,
